...
return new class extends Migration
{
    ...
    {
        Schema::table('producto_administrador', function (Blueprint $table) {
    ...
    {
        Schema::table('producto_administrador', function (Blueprint $table) {
            $table->dropForeign('producto_administrador_id_administradorfk_foreign');
            $table->dropForeign('producto_administrador_id_productofk_foreign');
        });
    }
};
